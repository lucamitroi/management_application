...
public class Add_Furniture extends JFrame
{
    ...
    JTextField productEnvironment = new JTextField();
    ...
    JLabel sexLabel = new JLabel("Environment:");
    ...
    public Add_Furniture()
    {
        ...
        productName.setBounds(110, 20, 165, 25);

        productQnt.setPreferredSize(new Dimension(250,25));
        productQnt.setBounds(110, 50, 165, 25);

        productPrice.setPreferredSize(new Dimension(250,25));
        productPrice.setBounds(110, 80, 165, 25);

        productMaterial.setPreferredSize(new Dimension(250,25));
        productMaterial.setBounds(110, 140, 165, 25);

        productType.setPreferredSize(new Dimension(250,25));
        productType.setBounds(110, 110, 165, 25);

        productEnvironment.setPreferredSize(new Dimension(250,25));
        productEnvironment.setBounds(110, 170, 165, 25);
        ...
        materialLabel.setBounds(10, 140, 165, 25);

        typeLabel.setForeground(Color.WHITE);
        typeLabel.setFont(new Font("Arial",Font.PLAIN,16));
        typeLabel.setBounds(10, 110, 165, 25);

        sexLabel.setForeground(Color.WHITE);
        sexLabel.setFont(new Font("Arial",Font.PLAIN,16));
        sexLabel.setBounds(10, 170, 165, 25);
        ...
        textPanel.add(productEnvironment);
        ...
        submitButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                String nameText, quantityText, priceText, typeText, materialText, environmentText;
                if(productName.getText().isEmpty() || productQnt.getText().isEmpty() || productPrice.getText().isEmpty() || productMaterial.getText().isEmpty() || productType.getText().isEmpty() || productEnvironment.getText().isEmpty())
                {
                ...
                else
                {
                    ...
                    environmentText = productEnvironment.getText();
                    ...
                    try
                    {
                        ...
                        myStmt.executeUpdate("INSERT INTO Furniture(idFurniture, furnitureType, material, environment) VALUES (SCOPE_IDENTITY(),'" + typeText +"', '" + materialText + "', '" + environmentText + "')");
                        myStmt.close();
                        myconn.close();
                        dispose();
                        new Add_Categories();
