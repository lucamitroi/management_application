...
public class Add_Tools extends JFrame
{
    ...
    public Add_Tools()
    {
        ...
        productType.setBounds(100, 110, 165, 25);
        ...
        submitButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                String nameText, quantityText, priceText, typeText;
                if(productName.getText().isEmpty() || productQnt.getText().isEmpty() || productPrice.getText().isEmpty() || productType.getText().isEmpty())
                {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        myStmt.executeUpdate("INSERT INTO Tools(idTools, toolType) VALUES (SCOPE_IDENTITY(), '" + typeText + "')");
                        myStmt.close();
                        myconn.close();
                        dispose();
                        new Add_Categories();
